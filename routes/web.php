...
use App\Http\Controllers\Tenant\SearchKostController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['role:tenant'])
        ...
        ->group(function () {
            ...
            Route::get('/kost', [SearchKostController::class, 'index'])
                ->name('kost.index');

            Route::get('/kost/suggest', [SearchKostController::class, 'suggestLocations'])
                ->name('kost.suggest');

            Route::get('/kost/{id}', [SearchKostController::class, 'show'])
                ->name('kost.show');
            ...
            // Payment routes
            Route::get('/payment/{rentalId}', [PaymentController::class, 'showPayment'])
                ->name('payment.show');
            Route::post('/payment/upload', [PaymentController::class, 'uploadProof'])
                ->name('payment.upload');
            Route::delete('/payment/cancel/{rentalId}', [PaymentController::class, 'cancelPayment'])
                ->name('payment.cancel');

            Route::post('/kost/favorite', [SearchKostController::class, 'toggleFavorite'])
                ->name('kost.favorite.toggle');
