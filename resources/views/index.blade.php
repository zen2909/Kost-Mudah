...
<head>
    ...
    <title>KostMudah - Cari Kost di Surabaya Timur Jadi Lebih Mudah</title>
...
<body>
    ...
    <nav
        ...
        <div class="max-w-[1280px] mx-auto flex justify-between items-center">
            ...
            <a href="{{ route('guest.home') }}" class="flex items-center gap-2">
                <div class="w-7 h-6 bg-slate-950 rounded"></div>
                <span class="text-slate-950 text-xl font-black">KostMudah</span>
            </a>

            <!-- Menu Tengah -->
            <div class="hidden md:flex items-center gap-8">
                <a href="#" class="pb-1 border-b-2 border-slate-950 text-slate-950 text-base font-bold">Home</a>
                <a href="#"
                    class="text-zinc-700 text-base font-medium hover:text-slate-950 transition">Featured</a>
                <a href="#"
                    class="text-zinc-700 text-base font-medium hover:text-slate-950 transition">Features</a>
                <a href="#"
                    class="text-zinc-700 text-base font-medium hover:text-slate-950 transition">Reviews</a>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                @else
                    <span class="text-slate-950 font-semibold">{{ Auth::user()->name }}</span>
    ...
    <!-- SEARCH BAR (Floating) -->
    <!-- ============================================================ -->
    <div class="max-w-[1232px] mx-auto px-4 -mt-20 relative z-10">
        <div
            ...
            <div class="flex-1 relative w-full">
                ...
                <input type="text" placeholder="Cari Lokasi (Sukolilo, Mulyorejo...)"
            ...
            <div class="flex-1 relative w-full">
                ...
                <input type="text" placeholder="Nama Kost atau Fasilitas"
                    class="w-full pl-12 pr-4 py-4 bg-white rounded-xl outline outline-1 outline-neutral-300 text-gray-500 focus:outline-sky-500 transition">
            </div>
            <button
    ...
    <section class="max-w-[1280px] mx-auto px-6 py-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="p-8 bg-white rounded-2xl outline outline-1 outline-neutral-300 relative">
                ...
                <p class="text-zinc-700 text-base leading-6">"Proses pencarian kost jadi jauh lebih cepat. Filter
                    lokasinya sangat membantu karena saya butuh kost yang dekat dengan kampus ITS."</p>
                <div class="flex items-center gap-4 mt-4 pt-4">
                    <div class="w-12 h-12 rounded-full outline outline-2 outline-neutral-300 overflow-hidden">
                        <img src="https://placehold.co/44x44" alt="Budi Santoso" class="w-full h-full object-cover">
                    </div>
                    <div>
                        <p class="text-slate-950 text-base font-bold">Budi Santoso</p>
                        <p class="text-zinc-700 text-sm">Mahasiswa ITS</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8 bg-white rounded-2xl outline outline-1 outline-neutral-300 relative">
                ...
                <p class="text-zinc-700 text-base leading-6">"Sangat terbantu dengan fitur Verified Owner. Saya tidak
                    perlu khawatir tertipu karena semua datanya sudah divalidasi oleh KostMudah."</p>
                <div class="flex items-center gap-4 mt-4 pt-4">
                    <div class="w-12 h-12 rounded-full outline outline-2 outline-neutral-300 overflow-hidden">
                        <img src="https://placehold.co/44x44" alt="Siti Aminah" class="w-full h-full object-cover">
                    </div>
                    <div>
                        <p class="text-slate-950 text-base font-bold">Siti Aminah</p>
                        <p class="text-zinc-700 text-sm">Karyawan Swasta</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8 bg-white rounded-2xl outline outline-1 outline-neutral-300 relative">
                ...
                <p class="text-zinc-700 text-base leading-6">"Tampilan aplikasinya sangat bersih dan modern. Mencari
                    kost di sekitar Mulyorejo jadi pengalaman yang menyenangkan."</p>
                <div class="flex items-center gap-4 mt-4 pt-4">
                    <div class="w-12 h-12 rounded-full outline outline-2 outline-neutral-300 overflow-hidden">
                        <img src="https://placehold.co/44x44" alt="Rizky Pratama" class="w-full h-full object-cover">
                    </div>
                    <div>
                        <p class="text-slate-950 text-base font-bold">Rizky Pratama</p>
                        <p class="text-zinc-700 text-sm">Mahasiswa UNAIR</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative max-w-[672px] mx-auto text-center">
                ...
                <div class="flex flex-wrap justify-center items-center gap-4 pt-4">
                    <a href="#"
                        ...
                        Kost Saya</a>
                    <a href="#"
                        class="px-8 py-4 rounded-xl outline outline-2 outline-white/20 text-white text-base font-bold hover:bg-white/10 transition">Hubungi
                        Sales</a>
                </div>
            </div>
        </div>
    ...
    <!-- FOOTER -->
    <!-- ============================================================ -->
    <footer class="w-full px-6 py-16 bg-zinc-200 border-t border-neutral-300">
        <div class="max-w-[1280px] mx-auto flex flex-col gap-12">
            <div class="flex flex-col md:flex-row justify-between items-start gap-8">
                <!-- Brand -->
                <div class="max-w-80">
                    <a href="{{ route('guest.home') }}" class="flex items-center gap-2 mb-4">
                        <div class="w-7 h-6 bg-slate-950 rounded"></div>
                        <span class="text-slate-950 text-xl font-bold">KostMudah</span>
                    </a>
                    <p class="text-zinc-700 text-base leading-6">Platform terdepan untuk mencari dan mengelola kost di
                        kawasan Surabaya Timur dengan aman dan mudah.</p>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-8 w-full md:w-auto">
                    <!-- Navigasi -->
                    <div>
                        <h4 class="text-slate-950 text-base font-bold mb-4">Navigasi</h4>
                        <ul class="space-y-2 text-zinc-700 text-base">
                            <li><a href="#" class="hover:text-slate-950 transition">Home</a></li>
                            <li><a href="#" class="hover:text-slate-950 transition">Cari Kost</a></li>
                            <li><a href="#" class="hover:text-slate-950 transition">Promo</a></li>
                            <li><a href="#" class="hover:text-slate-950 transition">Blog</a></li>
                        </ul>
                    </div>

                    <!-- Akun -->
                    <div>
                        <h4 class="text-slate-950 text-base font-bold mb-4">Akun</h4>
                        <ul class="space-y-2 text-zinc-700 text-base">
                            <li><a href="{{ route('login') }}" class="hover:text-slate-950 transition">Login</a>
                            </li>
                            <li><a href="{{ route('register') }}"
                                    class="hover:text-slate-950 transition">Register</a>
                            </li>
                            <li><a href="#" class="hover:text-slate-950 transition">Pusat Bantuan</a></li>
                        </ul>
                    </div>

                    <!-- Legalitas -->
                    <div>
                        <h4 class="text-slate-950 text-base font-bold mb-4">Legalitas</h4>
                        <ul class="space-y-2 text-zinc-700 text-base">
                            ...
                            <li><a href="#" class="hover:text-slate-950 transition">Contact Support</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <!-- Bottom Footer -->
            <div class="pt-8 border-t border-neutral-300 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-zinc-700 text-sm">© 2024 KostMudah Management System. All rights reserved.</p>
                <div class="flex items-center gap-8">
                    <a href="#" class="text-zinc-700 text-sm hover:text-slate-950 transition">Help Center</a>
                    <a href="#" class="text-zinc-700 text-sm hover:text-slate-950 transition">Contact
                        Support</a>
                </div>
            </div>
        </div>
