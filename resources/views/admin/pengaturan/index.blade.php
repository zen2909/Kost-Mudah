    ...
    <div class="max-w-7xl mx-auto">
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col items-center pt-4 pb-8">
                    <div class="relative">
                        <div
                            ...
                            <svg class="w-10 h-9 text-[#42474C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                        </div>
                        <button
                            class="absolute bottom-0 right-0 p-2 bg-[#06283D] rounded-full shadow-lg hover:bg-[#001220] transition-colors">
                    ...
                    <p class="text-[#42474C] text-xs font-medium uppercase tracking-wide mt-4">LOGO APLIKASI (1:1 RATIO)</p>
                </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" value="KostMudah Management System"
                    ...
                    <div>
                        ...
                        <textarea rows="3"
                            class="w-full px-4 py-2.5 bg-white border border-[#C3C7CD] rounded-lg text-[#191C1D] text-base focus:outline-none focus:ring-2 focus:ring-[#06283D] resize-none">Platform manajemen properti dan manajemen penghuni untuk efisiensi bisnis rumah kos Anda.</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-[#C3C7CD] shadow-sm overflow-hidden mb-6">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-[#191C1D] text-sm font-bold mb-1.5">Biaya Admin per Transaksi (Rp)</label>
                        <div class="relative">
                            <span
                ...
                <div class="pt-4 border-t border-[#C3C7CD]">
                    ...
                    <div class="space-y-3">
                        <!-- Invoice Pembayaran -->
                        <div class="flex items-center justify-between p-3 pl-3 pr-2.5 border border-[#C3C7CD] rounded-lg">
                            ...
                            <div class="w-10 h-5 bg-[#06283D] rounded-full relative cursor-pointer">
                                <div class="w-4 h-4 bg-white rounded-full absolute right-1 top-0.5 shadow-sm"></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-3 pl-3 pr-2.5 border border-[#C3C7CD] rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-[#42474C] text-xs">Kirim pengingat H-3 sebelum tanggal jatuh tempo.</p>
                                </div>
                            </div>
                            <div class="w-10 h-5 bg-[#06283D] rounded-full relative cursor-pointer">
                                <div class="w-4 h-4 bg-white rounded-full absolute right-1 top-0.5 shadow-sm"></div>
        ...
        <div class="bg-white rounded-xl border border-[#BA1A1A]/20 shadow-sm overflow-hidden mb-6">
            ...
            <div class="p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p class="text-[#42474C] text-sm max-w-2xl">Saat diaktifkan, user tidak dapat mengakses aplikasi. Hanya
                        admin yang dapat login untuk melakukan pemeliharaan.</p>
                </div>
                <div class="w-14 h-7 bg-[#C3C7CD] rounded-full relative cursor-pointer flex-shrink-0">
                    <div class="w-6 h-6 bg-white rounded-full absolute left-1 top-0.5 border border-[#C3C7CD] shadow-sm">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row justify-end items-center gap-4 pt-4">
            <button
                class="w-full sm:w-auto px-6 py-2.5 text-[#42474C] text-base font-semibold hover:text-[#191C1D] transition-colors">
                Batalkan Perubahan
            </button>
            <button
